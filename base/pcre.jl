...
function study(regex::Union(Ptr,Array{Uint8}), options::Integer)
...
study(re::Union(Ptr,Array{Uint8})) = study(re, int32(0))

free_study(extra::Ptr{Void}) =
    ccall((:pcre_free_study, :libpcre), Void, (Ptr{Void},), extra)

exec(regex::Union(Ptr,Array{Uint8}), extra::Ptr{Void}, str::SubString, offset::Integer, options::Integer, cap::Bool) =
    exec(regex, extra, str.string, str.offset, offset, sizeof(str), options, cap)
exec(regex::Union(Ptr,Array{Uint8}), extra::Ptr{Void}, str::ByteString, offset::Integer, options::Integer, cap::Bool) =
    exec(regex, extra, str, 0, offset, sizeof(str), options, cap)
function exec(regex::Union(Ptr,Array{Uint8}), extra::Ptr{Void},
